...
must_haves:
  truths:
    - "sitemap.xml exists in dist/ after build"
    - "robots.txt exists in dist/ after build with correct Allow directives"
    - ".br compressed files exist in dist/ after build"
    - ".gz compressed files exist in dist/ after build as fallback"
  artifacts:
    - path: "vite.config.ts"
